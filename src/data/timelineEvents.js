...
export const timelineEvents = [
  {
    id: "origins-1",
    title: "Who are the Arabs?",
    category: timelineCategories.ORIGINS,
    year: "8th Century BC",
    description: "The earliest documented evidence of Arab identity and culture.",
    icon: "👥",
    details: {
      quotes: [
        "Poetry is the record of the Arabs - Ibn Abbas",
        "Urge those in your presence to learn poetry, for it indicates noble morals, sound reasoning, and knowledge of lineage - Omar ibn al-Khattab"
      ],
  ...
  {
    id: "origins-2",
    title: "Arabic Origins",
    category: timelineCategories.ORIGINS,
    year: "Pre-Islamic Era",
    description: "The linguistic and cultural foundations of Arab identity.",
    icon: "📚",
    details: {
      quotes: [
        "We know very well that they say: 'A mortal teaches him.' The tongue of him at whom they hint is a non-Arab; and this is a clear Arabic tongue - Quran [An-Nahl: 103]"
      ],
  ...
  {
    id: "origins-3",
    title: "Ancient Geography of the Arabian Peninsula",
    category: timelineCategories.ORIGINS,
    year: "Pre-Islamic Era",
    description: "The geographical extent and features of the Arabian Peninsula.",
    icon: "🗺️",
    details: {
      quotes: [
        "Ibn Abbas was the first who has been credited to divide this country into provinces"
      ],
  ...
  {
    id: "pre-islamic-1",
    title: "Pre-Islamic Religions in Arabian Peninsula",
    category: timelineCategories.PRE_ISLAMIC,
    year: "Before 570 CE",
    description: "The diverse religious landscape of pre-Islamic Arabia.",
    icon: "🕌",
    details: {
      quotes: [
        "Adore not the sun nor the moon; but adore Allah Who created them, if it is in truth Him whom ye worship - Quran [Surat Fussilat: 37]",
        "May Allah have mercy on Quss, I hope on the Day of Resurrection that Allah will resurrect him as a nation of one man - Prophet Muhammad ﷺ"
      ],
  ...
  {
    id: "pre-islamic-2",
    title: "Arabs' Traits and Values",
    category: timelineCategories.PRE_ISLAMIC,
    year: "Pre-Islamic Era",
    description: "The noble characteristics and moral values of pre-Islamic Arabs.",
    icon: "⚔️",
    details: {
      quotes: [
        "I was sent to perfect good character - Prophet Muhammad ﷺ",
        "People are like gold and silver; those who were best in Jahiliyyah are best in Islam, if they have religious understanding - Prophet Muhammad ﷺ",
        "The strong man is not one who is good at wrestling, but the strong man is one who controls himself in a fit of rage - Prophet Muhammad ﷺ"
      ],
  ...
  {
    id: "pre-islamic-3",
    title: "Pre-Islamic Mecca",
    category: timelineCategories.PRE_ISLAMIC,
    year: "Pre-Islamic Era",
    description: "The sacred city's history, the Kaaba's construction, and the noble Al-Fudul Alliance.",
    icon: "🕋",
    details: {
      quotes: [
        "Surely the first House ˹of worship˺ established for humanity is the one at Bakkah—a blessed sanctuary and a guide for ˹all˺ people - Quran [Ali 'Imran: 96]",
        "I witnessed in the house of Abdullah ibn Jud'an an alliance. I would not wish to break it, even for the finest camels. And if I were called upon to that alliance in Islam, I would have responded - Prophet Muhammad ﷺ"
      ],
  ...
  {
    id: "pre-islamic-4",
    title: "The Prophet's ﷺ Biography: Concept and Sources",
    category: timelineCategories.PRE_ISLAMIC,
    year: "Historical Documentation",
    description: "Understanding the meaning, importance, and sources of the Prophet's biography (Sirah).",
    icon: "📚",
    details: {
      quotes: [
        "I was sent to perfect good character - Prophet Muhammad ﷺ",
        "The conduct of the Prophet ﷺ was entirely according to the Qur'an - Aishah (RA)"
      ],
  ...
  },
  {
    ...
    year: "570 CE",
    description: "The blessed birth and noble lineage of Prophet Muhammad ﷺ in Mecca.",
    icon: "👶",
    details: {
      quotes: [
        "All praise be to Allah who has blessed me with this pure boy - Abdul-Muttalib",
        "He has privilege over his peers even in infancy - Abdul-Muttalib"
      ],
  ...
  {
    id: "early-life-3",
    title: "The Prophet's ﷺ Childhood: Raising and Caring",
    category: timelineCategories.EARLY_LIFE,
    year: "570-576 CE",
    description: "The early years and upbringing of Prophet Muhammad ﷺ.",
    icon: "🤱",
    details: {
      quotes: [
        "Leave my son, what do you want from him? Don't you see it? He would be a great person - Abdul-Muttalib",
        "Has there been a prophet who did not shepherd them? - Prophet Muhammad ﷺ"
      ],
  ...
  {
    id: "early-life-4",
    title: "The Youth of the Prophet ﷺ: Preparation and Qualification",
    category: timelineCategories.EARLY_LIFE,
    year: "576-595 CE",
    description: "The formative years of Prophet Muhammad's ﷺ youth and early adulthood.",
    icon: "👱",
    details: {
      quotes: [
        "I witnessed in the house of Abdullah ibn Jud'an an alliance. I would not wish to break it, even for the finest camels - Prophet Muhammad ﷺ",
        "This is Al-Amin (the trustworthy one), we are pleased with his judgment - The People of Mecca"
      ],
  ...
  },
  {
    ...
    year: "610 CE",
    description: "The divine selection and beginning of revelation in Cave Hira, marking the start of prophethood.",
    icon: "📖",
    details: {
      quotes: [
        "Read, ˹O Prophet,˺ in the Name of your Lord Who created - First Revelation [Quran 96:1]",
...
9. Gradual Revelation: The wisdom in revealing the Quran over 23 years allowed for practical implementation and timeless guidance.`,
  ...
  {
    id: "migration-2",
    title: "The Migration to Abyssinia: Lessons and Morals",
    category: timelineCategories.MIGRATION,
    year: "615-616 CE",
    description: "The first migration in Islam and its profound lessons in justice, tolerance, and positive citizenship.",
    icon: "🛶",
    details: {
      quotes: [
        "Would that you emigrate to Abyssinia, whose ruler is a king with whom none is wronged, and it is a land of truth - Prophet Muhammad ﷺ",
        "Today a pious man has died. So get up and offer the funeral prayer for your brother Ashama - Prophet Muhammad ﷺ about the Negus",
        "By Allah, I have never known us to experience a sorrow that was more difficult for us than a sorrow at that time - Umm Salamah"
      ],
  ...
  },
  {
    ...
    category: timelineCategories.MIGRATION,
    year: "622 CE",
    description: "The Prophet's ﷺ historic journey from Mecca to Medina, marking the beginning of the Islamic calendar.",
    icon: "🐫",
    details: {
      quotes: [
        "What a fine town you are, and how dear you are to me! Were it not that my people expelled me from you, I would live nowhere else - Prophet Muhammad ﷺ",
        "Do not worry; Allah is certainly with us - Prophet Muhammad ﷺ to Abu Bakr",
        "O sons of Qayla! Your sought-after person has come - A Jewish man announcing the Prophet's arrival"
      ],
  ...
  },
  {
    ...
    year: "622 CE",
    description: "The first written constitution in Islamic history, establishing principles of peaceful coexistence and citizenship.",
    icon: "📜",
    details: {
      quotes: [
        "The Jews of Banu Awf shall be considered a community along with the believers - Constitution of Medina",
        "Mukhayriq is the best of Jews - Prophet Muhammad ﷺ",
        "Your brother, if you need his help, he will respond, and if you go to a fight, he will fight with you - Hujayyah bin al-Mudarrab"
      ],
  ...
  {
    id: "medina-3",
    title: "The Prophet's ﷺ Messages to the Kings of Other Nations",
    category: timelineCategories.MEDINA,
    year: "628-629 CE",
    description: "The Prophet's diplomatic correspondence with world leaders, demonstrating Islam's universal message and peaceful approach.",
    icon: "📜",
    details: {
      quotes: [
        "I have thoroughly examined the matter of this Prophet and found that he does not command anything that is improper - Al-Muqawqis",
...
4. Ethical Foundation:
  ...
  },
  {
    ...
    year: "624 CE (2 AH)",
    description: "The first major battle in Islamic history, demonstrating divine support and strategic warfare.",
    icon: "⚔️",
    details: {
      quotes: [
        "O Messenger of Allah, go forth in what Allah has commanded and we are with you! - Miqdad ibn Aswad",
...
4. Leadership Lessons:
  ...
  },
  {
    ...
    category: timelineCategories.BATTLES,
    year: "627 CE (5 AH)",
    description: "A defensive battle showcasing innovative military strategy and divine intervention.",
    icon: "⚔️",
    details: {
      quotes: [
        "O Allah, Revealer of the Book, Swift to account, defeat the groups - Prophet Muhammad ﷺ",
        "War is deceit - Prophet Muhammad ﷺ to Nu'aym ibn Mas'ud",
        "O Allah, cover our danger points and grant us security from our fears - The Muslims"
      ],
  ...
  {
    id: "medina-4",
    title: "The Conquest of Mecca and the Year of Delegations",
    category: timelineCategories.MEDINA,
    year: "630-631 CE (8-9 AH)",
    description: "The peaceful conquest of Mecca and subsequent acceptance of Islam by Arab tribes across the peninsula.",
    icon: "🕋",
    details: {
      quotes: [
        "O people of Quraysh, what do you think I will do to you? - Prophet Muhammad ﷺ",
        "We think you will treat us kindly, as you are our good brother and the son of a good brother - The People of Quraysh",
        "There is no blame on you today, go, for you are free - Prophet Muhammad ﷺ"
      ],
  ...
  {
    id: "medina-5",
    title: "Farewell Pilgrimage and the Prophet's ﷺ Death",
    category: timelineCategories.MEDINA,
    year: "632-633 CE (10-11 AH)",
    description: "The Prophet's ﷺ final pilgrimage, farewell sermon, and passing from this world.",
    icon: "🕋",
    details: {
      quotes: [
        "O People, lend me an attentive ear, for I know not whether after this year, I shall ever be amongst you again - Prophet Muhammad ﷺ",
        "O Allah! Forgive me and bestow Your Mercy on me and let me join with the exalted companions - Prophet Muhammad's ﷺ final words",
        "Learn your rites, for I do not know whether I am likely to perform the pilgrimage after this occasion - Prophet Muhammad ﷺ"
      ],
  ...
  {
    id: "orientalism-1",
    title: "The Efforts of Orientalists in Serving the Prophet's ﷺ Biography",
    category: timelineCategories.ORIENTALISM,
    year: "10th-20th Century CE",
    description: "Western scholarly contributions to Islamic studies and Prophetic biography.",
    icon: "📚",
    details: {
      quotes: [
        "Muhammad is not a liar, nor a fabricator. Rather, he is a piece of life which emerged from the essence of nature - Thomas Carlyle",
